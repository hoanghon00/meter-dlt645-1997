#ifndef HTLCDlib_JS_h
#define HTLCDlib_JS_h


#undef HTLCD_JS_EXT
#ifndef HTLCD_JS_C
#define HTLCD_JS_EXT extern
#else
#define HTLCD_JS_EXT
#endif

HTLCD_JS_EXT INT8U Show_Lcd_Ram[MAX_SEG+1];         //0~MAX_SEG
HTLCD_JS_EXT INT8U Show_Lcd_Flag;
...
HTLCD_JS_EXT const LCD_S_D_POS LCD_S_Const[]=
{ 
  {0,0,0},			//位置0，表示为空
  {1,23,1},
  {2,23,2},
...
HTLCD_JS_EXT const LCD_S_D_POS LCD_D_Const[]=
{
  {0,0,0},      //位置0，表示为空
  {4,1,7},      //:
  {6,3,7},      //:
...
HTLCD_JS_EXT const LCD_N_POS LCD_N_Const[]=
{
...
//对'8'的描述
HTLCD_JS_EXT const LCD_LED LED_Pixy8_Const[]=
{ {0},
  {'0',6,{'A','B','C','D','E','F'}},
  {'1',2,{'B','C'}},
  {'2',5,{'A','B','D','E','G'}},
