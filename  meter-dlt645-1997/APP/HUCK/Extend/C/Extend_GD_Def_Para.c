...
CONST INT8U Def_C048[]={0x06};//模式字2
CONST INT8U Def_C049[]={0x20};//模式字3//套费率方案切换变为是否允许时段表切换
CONST INT8U Def_C04A[]={0x02};//模式字4
CONST INT8U Def_C04B[]={0x06};//模式字5
CONST INT8U Def_C04C[]={0x0F};//模式字6
CONST INT8U Def_C04D[]={0x0C};//模式字7
CONST INT8U Def_C04E[]={0xFF};//模式字8
...
//默认电量数据，CUR_ENERGY_BAK0是读取数据是最后一个读取项，因此选择为该项提供默认项,一下几项皆同
  ...
  {TOTAL_LOSS_VOL_OCCUR_TIME,8,Zero},
  {TOTAL_LOSS_VOL_END_TIME,8,Zero},
